...
export const TERMS: Term[] = [
  ...
  },
  {
    ...
    inDylan:
      "Dylan was already a Newport regular: he had been introduced to the festival by Pete Seeger, who saw him as the movement's most important new voice. By 1963 he was being hailed as a king of folk at Newport, and by 1964 he was moving away from protest songs toward more personal, surreal writing. The 1965 festival was therefore both the climax of his folk apprenticeship and the moment he declared his independence from it. Backed by members of the Paul Butterfield Blues Band — Mike Bloomfield on guitar, Al Kooper on organ, and others — Dylan opened his short Sunday-night set with Maggie's Farm. The electric instruments, the volume, and the restless crowd reaction have been debated, mythologized, and reinterpreted ever since. Accounts differ on whether Pete Seeger tried to cut the cables because he could not hear the words, or simply objected to the sound; whatever the truth, the moment symbolized the fracturing of the folk-revival consensus and the arrival of rock as a serious adult language. Dylan returned the next year, 1966, for a final, peaceful acoustic performance after his motorcycle accident, closing the chapter on one of the most consequential weekends in modern music.",
    example: {
